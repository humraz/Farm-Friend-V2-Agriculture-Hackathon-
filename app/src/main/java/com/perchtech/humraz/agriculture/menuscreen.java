package com.perchtech.humraz.agriculture;
       ...
       bmb();
        ...
        bottomBar.setOnTabSelectListener(new OnTabSelectListener() {
            ...
            public void onTabSelected(@IdRes int tabId) {
                if (tabId == R.id.t_fav) {
                   // Intent in = new Intent(menuscreen.this, sunmain.class);
                    //startActivity(in);
                }
                if (tabId == R.id.t_near) {
                    // m();
                   Intent in = new Intent(menuscreen.this, MainActivity.class);
                    startActivity(in);
                }
                if (tabId == R.id.t_fri) {
                    Intent in = new Intent(menuscreen.this, createlisting.class);
                    startActivity(in);
                }
            }
        });
